                    ...
                    >
                        <div>
                            ...
                            <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed max-w-xl">
                                Senior Mobile Engineer & UI Architect. I build high-performance, design-led digital
                                products that scale.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <Button size="lg" variant="outline" className="h-16 px-8 rounded-full text-lg font-bold"
                        ...
                        <div className="flex items-center gap-8 pt-8 border-t border-border/50">
                            ...
                            <div>
                                ...
                                <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Projects
                                    Delivered</p>
                            </div>
                            <div>
                                <p className="text-2xl font-bold">Nepal</p>
                                <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Based
                                    Location</p>
                            </div>
                        </div>
                    </motion.div>
